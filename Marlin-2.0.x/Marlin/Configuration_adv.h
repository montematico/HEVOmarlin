...
//#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN      35 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
//#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  10, 150 }, { 150,  150}}
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 230,  30 }, { 230, 270 }, { 30, 270 } }
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.0125       // (steps or mm) Steps or millimeter distance for each Z babystep
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     103  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
